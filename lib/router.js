...
Router.route('/refs/:_id', {
    name: 'ref',
    waitOn: function () {
        return Meteor.subscribe('singleRef', generateId(this.params._id));
    },
    data: function () {
        return {
            ref: Refs.findOne()
...
Router.route('/refs/:_id/annotate', {
    name: 'refAnnotate',
    waitOn: function () {
        return Meteor.subscribe('singleRef', generateId(this.params._id)) && Meteor.subscribe('allDictsWithWords');
    },
    data: function () {
        return {
            ref: Refs.findOne()
...
Router.route('/dicts/:_id/edit', {
    name: 'dictedit',
    waitOn: function () {
        return Meteor.subscribe('singleDict', generateId(this.params._id));
    },
    data: function () {
        return {
