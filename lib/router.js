...
Router.route('/dip/:_id', {
    ...
    waitOn: function () {
        var oid = new Mongo.ObjectID(this.params._id);
        return [
            Meteor.subscribe('singleDeputyById', oid),
            Meteor.subscribe('limitedTipiListByDeputy', oid)
        ];
    },
    data: function() {
...
Router.route('/grupo/:_id', {
    ...
    waitOn: function () {
        var oid = new Mongo.ObjectID(this.params._id);
        return [
            Meteor.subscribe('singleGroupById', oid),
            Meteor.subscribe('limitedTipiListByGroup', oid)
        ];
    },
    data: function() {
